...
export default class CamIcon extends React.Component {
    static defaultProps = {
        size: 64,
        color: '#000'
    };
            ...
            >
                <g>
                    <g id="_x33__13_">
                        <g>
                            <path fill={color}
                                d="M573.75,267.75L459,344.25c0-23.218-10.557-43.758-26.89-57.796c38.881-23.428,65.14-65.637,65.14-114.329
